...
# Optimized: Replaced the static 1000-task generation loop with Dynamic Task Mapping.
# This prevents scheduler bottlenecks and brings DAG parse time well within the <2s threshold.
with DAG(
