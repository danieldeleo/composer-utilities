...
def generate_bash_commands():
    # Dynamically generate commands at runtime instead of statically creating tasks at parse time
...
with DAG(
    ...
    # Optimized: Using dynamic task mapping to avoid top-level loop that slows down DAG parsing
