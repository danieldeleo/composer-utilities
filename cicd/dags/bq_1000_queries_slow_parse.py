...
# Refactored from static Python loop of 1000 tasks (an anti-pattern that creates 4000 operator instances
# at top-level parse time and degrades scheduler performance) to dynamic task mapping using @task and .expand().
# This reduces parse time significantly to under the 2.0s threshold while preserving task semantics.
