...
# Optimization: Refactored from static loop (1000 tasks) to dynamic task mapping.
# Static generation of thousands of tasks bloats DAG size and slows down scheduler parsing.
# Dynamic task mapping evaluates mapped inputs at runtime and keeps parse times minimal.
