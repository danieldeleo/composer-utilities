...
# Optimized: Replaced static 1000-iteration loop with dynamic task mapping (.expand())
# to minimize top-level code overhead and keep DAG parsing fast and scalable.
with DAG(
