...
# Optimized using Dynamic Task Mapping instead of a static 1,000-task top-level loop.
# This keeps the DAG definition lightweight, fast to parse (<2s threshold), and scalable.
