...
def dagbag():
    ...
    # Pre-import standard provider operators so DAG parsing measurements isolate
    # DAG construction performance without initial Python disk I/O cold-start skew.
    try:
